...
async def general_llm_eval(payload: IntelligenceEvalInput):
    ...
    if payload.mmlu_pro:
        ...
        mmlu_pro_dataset, _ = train_test_split(mmlu_pro_dataset_mod[10000:11000], train_size = 50, stratify = mmlu_pro_dataset_mod[10000:11000]["category"], random_state = None)
